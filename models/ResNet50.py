...
# %%
plot_model(model,
            to_file='../model_arc/ResNet50.png',
            show_shapes=True,
...
# %%
with open("../graph/ResNet.txt", "w") as outfile:
    outfile.write(f"resnet_train_accuracy={hist.history['accuracy']}\nresnet_validation_accuracy={hist.history['val_accuracy']}\nresnet_train_loss={hist.history['loss']}\nresnet_validation_loss={hist.history['val_loss']}\nresnet_test_loss={test_loss}\nresnet_test_accuracy={test_acc}\n")
# %%
